...
public class MainMenuActivity extends Activity implements OnClickListener {
	...
	private void initView() {
		...
		Button mInstructionsButton = (Button) findViewById(R.id.instructions);
		Button mSettingsButton = (Button) findViewById(R.id.settings);

		Typeface type = Typeface.createFromAsset(this.getAssets(),
				"fonts/jellybelly.ttf");
	...
	class UnzipFileAsync extends AsyncTask<String, String, String> {
			...
			try {
				...
				while (e.hasMoreElements()) {
					...
					File destinationFilePath = new File(
							Utility.getExternalDataFolder(), entry.getName());
		...
		protected void onPostExecute(String unused) {
			...
			// now enable the launch game button so the player can get on with
			// it
			mLaunchButton.setEnabled(true);
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.launchGame:
			mLogo.stopAnimating();
			intent = new Intent(getApplicationContext(), SDLActivity.class);
			startActivity(intent);
			break;
		case R.id.instructions:
			...
			break;
		case R.id.settings:
			intent = new Intent(getApplicationContext(), SMWSettings.class);
			startActivity(intent);
			break;
		default:
			break;
